...
const Contact = () => {
	return <div className="bg-white pt-20 px-8 md:px-12 lg:px-40 pb-40">
		<div className="flex flex-col lg:flex-row rounded-xl drop-shadow-lg bg-white -mt-80">
			...
			<div className="lg:w-1/2 px-8 md:px-12 lg:pr-20 pb-12 lg:pb-0">
				...
				<div className="mt-8">
					...
					<input placeholder="Please input your email" className="w-full border-2 h-12 p-4 mt-2" />
				</div>
				<div className="mt-8">
					<p className="text-xl font-semibold">Your Name</p>
					<input placeholder="Please input your name" className="w-full border-2 h-12 p-4 mt-2" />
				</div>
				<div className="mt-8">
					<p className="text-xl font-semibold">Your Phone</p>
					<input placeholder="Please input your phone number" className="w-full border-2 h-12 p-4 mt-2" />
				</div>
				<div className="mt-8">
					<p className="text-xl font-semibold">Message</p>
					<input multiple placeholder="Tell us your goal! E.g. I want TOP 3 on Google, etc." className="w-full border-2 h-32 p-4 mt-2" />
				</div>
				<div className="mt-8">
